...
class _ChartPageState extends State<ChartPage> {
  var data = [0.0, 1.0, 1.5, 2.0, 3.0, 0.0, -1.5, -1.0, -0.5, 0.0, 0.0 ,1.0, 1.5, 2.0];
        ...
        child:StaggeredGridView.count(
          ...
          children: <Widget>[
            Padding(
              ...
              child: mychart1Items("Sales by Month","502.3M","+12.9% of target"),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: myCircularItems("Quarterly Profits","100.7M"),
            ),
            Padding(
